...
build/openstack-role-helper: FORCE
	go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/openstack-role-helper .
...
install: FORCE build/openstack-role-helper
	install -D -m 0755 build/openstack-role-helper "$(DESTDIR)$(PREFIX)/bin/openstack-role-helper"
