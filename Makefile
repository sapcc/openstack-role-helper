...
install: FORCE build/openstack-role-helper
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/openstack-role-helper "$(DESTDIR)$(PREFIX)/bin/openstack-role-helper"
...
goimports: FORCE
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/openstack-role-helper\e[0m\n"
	@goimports -w -local https://github.com/sapcc/openstack-role-helper internal/ $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
...
help: FORCE
	...
	@printf "  \e[36mbuild/openstack-role-helper\e[0m  Build openstack-role-helper.\n"
